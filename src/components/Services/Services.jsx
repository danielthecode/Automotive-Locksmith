          ...
          {/* <div className="wrapper-content first">
            <div className="left">
              ...
              <div className="description">
                <p>
                  In the unfortunate event of your vehicle key being lost or stolen, Car Key Experts can help you
                  replace
                  the key without any damage to your vehicle.
                  <br />
                  <p className={expandOpen1 ? 'hidden' : 'visible' }>
                    Our highly skilled technicians will perform an ‘All Keys Lost’ function using our specialist
                    equipment
                    to ensure that all registered keys are erased from the vehicle memory and no longer recognised by
                    the
                    vehicle’s immobiliser system. We will then cut and programme a new key for you to restore your
                    vehicle
                    to full functionality. All of this is done at a fraction of what you would be charged by a
                    dealership
